...
// These tests are nearly identical to `client.test.jsx` except for the value of `global.module`
// NOTE: putting these tests into the same file causes the require statement to cache, failing the last test
describe('client.jsx with hot module reloading', () => {
  ...
  beforeAll(() => {
    ...
    global.module = { hot: { accept: jest.fn() } };
  ...
  it('module.hot.accept was called', () => {
    expect(global.module.hot.accept).toHaveBeenCalled();
  });
});
